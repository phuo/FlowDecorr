...
class flowAsyTwistATLAS{
    ...
    private:
        ...
        TProfile* hfg_4q [NTYPE][REF_FCAL][HALF_TRK][NHAR][2]; //0 is real, 1 is imaginary part
        TProfile* hfg_4q0[NTYPE][REF_FCAL][HALF_TRK][NHAR][2]; //0 is real, 1 is imaginary part
        TProfile* hfg_4q1[NTYPE][REF_FCAL][HALF_TRK][NHAR][2]; //0 is real, 1 is imaginary part
        TProfile* hfg_ref[REF_FCAL][NHAR][2];
        TProfile* hfg_det[NTYPE][HALF_TRK][NHAR][2];

        TProfile* hfg_cms_0[NTYPE][REF_FCAL][HALF_TRK][NHAR][2];  //numerator
        TProfile* hfg_cms_1[NTYPE][REF_FCAL][HALF_TRK][NHAR][2];  //denominator

        TProfile* hbg_4q [NTYPE][REF_FCAL][HALF_TRK][NHAR][2]; //0 is real, 1 is imaginary part
        TProfile* hbg_4q0[NTYPE][REF_FCAL][HALF_TRK][NHAR][2]; //0 is real, 1 is imaginary part
        TProfile* hbg_4q1[NTYPE][REF_FCAL][HALF_TRK][NHAR][2]; //0 is real, 1 is imaginary part
        TProfile* hbg_ref[REF_FCAL][NHAR][2];
        TProfile* hbg_det[NTYPE][HALF_TRK][NHAR][2];

        TProfile* hbg_cms_0[NTYPE][REF_FCAL][HALF_TRK][NHAR][2];  //numerator
        TProfile* hbg_cms_1[NTYPE][REF_FCAL][HALF_TRK][NHAR][2];  //denominator
